package com.server.batch.trading.auto.dto;
...
public class ValueSendRequestDto {
    ...
    public ValueSendRequestDto(
        ...
        this.rsi = rsi;
        this.macd_50 = macd_50;
        this.macd_200 = macd_200;
    }
    ...
    public ValueSendRequestDto(JsonObject object) {
        ...
        this.rsi = object.get("rsi").getAsDouble();
        this.macd_50 = object.get("macd_50").getAsInt();
        this.macd_200 = object.get("macd_200").getAsInt();
    }
